    ...
    <main>
      ...
      <article className="max-w-3xl mx-auto p-5">
        ...
        <div className="flex items-center space-x-2">
          ...
          <p className="font-extralight text-sm pl-2">Blog post by <span className="text-green-600">{post.author.name}</span> - Published on {new Date(post._createdAt).toLocaleString()}{" "} </p>
        </div>
